...
public class TagHandler : MonoBehaviour
{
    ...
    // dam bao khong set duoc chi get thoi 
    ...
    public class Point 
    {
        public Vector3 coordinate { get; set; }  // toa do
        public Vector3 direction { get; set; }  // huong
        public float angle { get; set; }   // goc
    ...
    public void OnMove()
    {
        ...
        {
            denoteTag(addedTag); // bieu thi the 
            moveTag(addedTag);  // di chuyen the
        }
    }
    ...
    public void denoteTag(GameObject addedTag)
    {
        ...
        {
            addedTag.transform.GetChild(0).transform.GetComponent<LineRenderer>().enabled = true;
            addedTag.transform.GetChild(1).transform.GetComponent<MeshRenderer>().enabled = true; 
            addedTag.transform.GetChild(2).transform.GetComponent<MeshRenderer>().enabled = true; 
    ...
    public void moveTag(GameObject addedTag)
    {
        ...
        addedTag.transform.GetChild(3).transform.LookAt(addedTag.transform.GetChild(2).position + Camera.main.transform.rotation * Vector3.forward, Camera.main.transform.rotation * Vector3.up); 
